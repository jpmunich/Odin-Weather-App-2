/******/ (() => {
  ...
  \*****************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ createElementWithClass: () =>
            /* binding */ createElementWithClass,
          /* harmony export */ createForecastCell: () =>
            /* binding */ createForecastCell,
          /* harmony export */ createTextElement: () =>
            /* binding */ createTextElement,
          /* harmony export */ createWeatherCell: () =>
            /* binding */ createWeatherCell,
          /* harmony export */
        });
        ...
        const createWeatherCell = (parent, imgSrc, infoTypeText, infoText) => {
          ...
          const icon = createElementWithClass(
            "img",
            iconContainer,
            "weather-cell-img"
          );
  ...
  \******************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ requestForecast: () =>
            /* binding */ requestForecast,
          /* harmony export */
        });
        ...
        async function requestData(city) {
          ...
          (0, _home__WEBPACK_IMPORTED_MODULE_0__.updateBackground)(
            weather[0].main,
            hour
          );
        ...
        async function requestForecast(city) {
          ...
          (0, _home__WEBPACK_IMPORTED_MODULE_0__.updateForecastValues)(
            highs,
            lows
          );
        }
  ...
  \*********************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ createBackground: () =>
            /* binding */ createBackground,
          /* harmony export */ updateBackground: () =>
            /* binding */ updateBackground,
          /* harmony export */ updateCellValues: () =>
            /* binding */ updateCellValues,
          /* harmony export */ updateForecastDay: () =>
            /* binding */ updateForecastDay,
          /* harmony export */ updateForecastValues: () =>
            /* binding */ updateForecastValues,
          /* harmony export */ updateNavValues: () =>
            /* binding */ updateNavValues,
          /* harmony export */
        });
        /* harmony import */ var _UIController_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./UIController.js */ "./src/UIController.js");

        let units = "imperial";

        const content = document.getElementById("content");
        const topContent = (0,
        _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)(
          "div",
          content,
          "top-content"
        );
        ...
        function createBackground() {
          content.style.backgroundImage = "url(./images/landscape.jpg)";
        }
        ...
        function updateBackground(weather, time) {
          ...
          if (weather === "Rain" || weather === "Drizzle")
            ...
            content.style.backgroundImage = `url(./images/lightning-strike.jpg)`;
          else if (weather === "Thunderstorm" && random === 1)
            content.style.backgroundImage = `url(./images/lightning.jpg)`;
          else if (weather === "Mist" || weather === "Fog")
            content.style.backgroundImage = `url(./images/cloudy-forest.jpg)`;
          else if (weather === "Clouds")
            content.style.backgroundImage = `url(./images/cloudy-day.jpg)`;
          else if (weather === "Smoke" || weather === "Haze")
            content.style.backgroundImage = `url(./images/cloudy-forest.jpg)`;
          else if (weather === "Dust" || weather === "Sand")
            content.style.backgroundImage = `url(./images/desert.jpg)`;
          else if (weather === "Snow" && random === 0)
            content.style.backgroundImage = `url(./images/snow.jpg)`;
          else if (weather === "Snow" && random === 1)
            content.style.backgroundImage = `url(./images/snowy-forest.jpg)`;
          else {
            content.style.backgroundImage = `url(./images/landscape.jpg)`;
          }

          if (weather === "Clear" && (time >= 19 || time <= 8))
            content.style.backgroundImage = `url(./images/night-time.jpg)`;
        }

        function createNav(weatherDescription, city, date, temperature) {
          const navContainer = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)(
            "div",
            topContent,
            "nav-container"
          ...
          const weatherText = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createTextElement)(
            "h1",
            navContainer,
            weatherDescription
          );
          ...
          weather.src = "./images/cloudy.svg";

          const searchContainer = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)(
            "div",
            navContainer,
            "search-container"
          ...
          const search = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createElement)(
            "input",
            searchContainer
          );
          ...
          searchBar.src = "./images/search.svg";
        }
        ...
        function updateNavValues(weatherDescription, city, date, temperature) {
          ...
          if (units === "imperial")
            ...
            tempuratureText.innerText = `${temperature} °C`;
        }
        ...
        function createWeatherCellGrid(
          ...
          const sunriseCell = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createWeatherCell)(
            leftCellContainer,
            "./images/sunrise.svg",
            "Sunrise",
            sunrise
        ...
        function updateCellValues(
          ...
          const windDirectionCell = document.getElementById(
            "wind-direction-cell"
          );
        ...
        function createForecast(highs, lows) {
          const toggleContainer = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)(
            "div",
            content,
            "toggle-container"
          );
          const toggleForecastDaily = (0,
          _UIController_js__WEBPACK_IMPORTED_MODULE_0__.createTextElement)(
            "button",
            toggleContainer,
            "Daily Forecast"
  ...
  \**********************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _apiController_js__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./apiController.js */ "./src/apiController.js");
    ...
    (0, _apiController_js__WEBPACK_IMPORTED_MODULE_0__.requestForecast)(
      "Seattle"
    );
  })();
